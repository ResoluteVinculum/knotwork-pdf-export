...
export function buildDocCSS(s: PDFExportSettings, isRTL = false): string {
  ...
  .mpdf-doc {
    ...
    --mpdf-fontSize: ${s.fontSize};
    --mpdf-lineHeight: ${s.lineHeight};
    --mpdf-paragraphSpacing: ${s.paragraphSpacing};
    --mpdf-headingScale: ${s.headingScale};
    --mpdf-accentColor: ${s.accentColor};
    --mpdf-bodyColor: ${s.bodyColor};
    --mpdf-boldColor: ${s.headingColor};
    --mpdf-h1BorderBottom: ${s.h1BorderBottom};
    --mpdf-h2BorderBottom: ${s.h2BorderBottom};
    --mpdf-centerH1: ${s.centerH1};
    --mpdf-blockquoteBg: ${s.blockquoteBg};
    --mpdf-blockquoteBorderColor: ${s.blockquoteBorderColor};
    --mpdf-codeBackground: ${s.codeBackground};
    --mpdf-codeFontSize: ${s.codeFontSize};
    --mpdf-codeFontFamily: ${s.codeFontFamily};
    --mpdf-codeTheme: ${s.codeTheme};
    --mpdf-tableHeaderBg: ${s.tableHeaderBg};
    --mpdf-tableStriped: ${s.tableStriped};
    --mpdf-pageBackground: ${s.pageBackground};
    --mpdf-marginTop: ${s.marginTop};
    --mpdf-marginBottom: ${s.marginBottom};
    --mpdf-marginLeft: ${s.marginLeft};
    --mpdf-marginRight: ${s.marginRight};

    /* Default */
    --mpdf-pageSize: ${s.pageSize};
    --mpdf-orientation: ${s.orientation};
    --mpdf-preset: ${s.preset};
    --mpdf-headerText: ${s.headerText};
    --mpdf-footerText: ${s.footerText};
    --mpdf-showHeader: ${s.showHeader};
    --mpdf-showFooter: ${s.showFooter};
    --mpdf-showHeaderBorder: ${s.showHeaderBorder};
    --mpdf-showFooterBorder: ${s.showFooterBorder};
    --mpdf-showPageNumbers: ${s.showPageNumbers};
    --mpdf-pageNumberPosition: ${s.pageNumberPosition};
    --mpdf-pageNumberStart: ${s.pageNumberStart};
    --mpdf-pageNumberFormat: ${s.pageNumberFormat};
    --mpdf-showHeaderOnFirstPage: ${s.showHeaderOnFirstPage};
    --mpdf-showFooterOnFirstPage: ${s.showFooterOnFirstPage};
    --mpdf-headerAlignment: ${s.headerAlignment};
    --mpdf-footerTextAlignment: ${s.footerTextAlignment};
    --mpdf-headerFontSize: ${s.headerFontSize};
    --mpdf-headerFontColor: ${s.headerFontColor};
    --mpdf-footerFontSize: ${s.footerFontSize};
    --mpdf-footerFontColor: ${s.footerFontColor};
    --mpdf-linkUnderline: ${s.linkUnderline};
    --mpdf-frameEnabled: ${s.frameEnabled};
    --mpdf-frameColor: ${s.frameColor};
    --mpdf-frameThickness: ${s.frameThickness};
    --mpdf-frameMargin: ${s.frameMargin};
    --mpdf-frameStyle: ${s.frameStyle};
    --mpdf-hideFrontmatter: ${s.hideFrontmatter};
    --mpdf-customFontName: ${s.customFontName};
    --mpdf-customCodeFontName: ${s.customCodeFontName};
    --mpdf-codeFontLigatures: ${s.codeFontLigatures};
    --mpdf-autoBreakH1: ${s.autoBreakH1};
    --mpdf-autoBreakH2: ${s.autoBreakH2};
    --mpdf-includeFilenameAsTitle: ${s.includeFilenameAsTitle};
    --mpdf-previewScale: ${s.previewScale};
    --mpdf-customPageWidth: ${s.customPageWidth};
    --mpdf-customPageHeight: ${s.customPageHeight};
    --mpdf-headerHeight: ${s.headerHeight};
    --mpdf-footerHeight: ${s.footerHeight};
    --mpdf-headerImagePath: ${s.headerImagePath};
    --mpdf-headerImageMargin: ${s.headerImageMargin};
    --mpdf-footerImagePath: ${s.footerImagePath};
    --mpdf-footerImageMargin: ${s.footerImageMargin};
    --mpdf-backgroundImageEnabled: ${s.backgroundImageEnabled};
    --mpdf-backgroundImagePath: ${s.backgroundImagePath};
    --mpdf-backgroundImageSize: ${s.backgroundImageSize};
